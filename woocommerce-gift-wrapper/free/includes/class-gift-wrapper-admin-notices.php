...
class The_Gift_Wrapper_Admin_Notices {
	...
	public static function check_template_outdated( $files ) {
		...
		foreach ( $files as $file ) {
			...
			if ( file_exists( get_stylesheet_directory() . 'class-gift-wrapper-admin-notices.php/' . WC()->template_path() . $file ) ) {
				$theme_file = get_stylesheet_directory() . 'class-gift-wrapper-admin-notices.php/' . WC()->template_path() . $file;
			} elseif ( file_exists( get_template_directory() . 'class-gift-wrapper-admin-notices.php/' . WC()->template_path() . $file ) ) {
				$theme_file = get_template_directory() . 'class-gift-wrapper-admin-notices.php/' . WC()->template_path() . $file;
			}
